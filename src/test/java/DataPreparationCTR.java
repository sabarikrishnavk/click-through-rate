...
import com.pgbde.spark.mllib.Constants;
...
public class DataPreparationCTR {
	...
	public static void main(String[] args) {
		...
		String saveMode =  (args.length >= 6) ?args[5]: Constants.SAVEMODE_I;
...
//5525c71b6213340569f3aa1abc225514,1533115844,_JUdlvPU,20180801
		...
		if(Constants.SAVEMODE_I.equals(saveMode)) {
...
//Drop the columns
			...
			System.out.println("Output data count:" +outputData.count());
